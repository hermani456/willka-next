export default function Hero() {
    return (
      <div className="bg-gray-900 px-6 pt-14 lg:px-8 font-montserrat" id="home">
        <div className="mx-auto max-w-2xl py-10 sm:py-36 lg:py-40">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-white font-montserrat">
              Ofrecemos soluciones integrales y de alta calidad en <span className="font-bold">hospedaje, alimentación,
              transporte, aseo industrial, seguridad y fumigación</span>, asegurando el
              bienestar y satisfacción de nuestros clientes, mientras garantizamos
              prácticas sostenibles y éticas en cada uno de nuestros servicios.
            </p>
