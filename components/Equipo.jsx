...
export default function Example() {
  return (
    <div className="bg-gray-900 font-montserrat" id="equipo">
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        ...
        <div className="flex flex-col  flex-wrap">
          ...
          {equipo.map((person) => (
            <div
              key={person.name}
              className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8 shadow-lg rounded-lg bg-gray-800 mb-5 p-5"
            >
