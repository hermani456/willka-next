...
import van from "public/assets/transporte/van.jpg";
        ...
        <header className="relative h-dvh h-screen flex justify-center text-white font-montserrat">
          ...
          <div className="relative flex items-center flex-col justify-center">
            ...
            <p className="mx-10 md:mx-36 xl:mx-96 text-xl font-bold bg-white text-black p-5 opacity-75 rounded-xl">
              ...
              personales, confía en nuestra flota y en nuestro compromiso con tu
              bienestar. ¡Reserva tu viaje hoy y experimenta un transporte de
              calidad y confianza!
            </p>
          </div>
        </header>
